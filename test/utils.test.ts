...
import { getPkgsToBeInstalled, queryPackageInfo, validatePackageName } from "../src/utils";
...
describe("Test utils", () => {
  describe("#getPkgsToBeInstalled()", () => {
    it("should get correct packages to be installed", async () => {
      ...
      const result6 = await getPkgsToBeInstalled(["chalk", "mocha"]);
